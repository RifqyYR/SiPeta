...
@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h4 class="h4 mb-0 text-info">Data Pertumbuhan Bayam</h4>

            <a href="{{ route('plant.spinach.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i
                ...
                <table class="table table-bordered table-striped table-sm datatable" id="dataTable" width="100%"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="background-green text-center">Temperatur Lingkungan</th>
                            <th class="background-green text-center">pH Tanah</th>
                    ...
                    <tbody>
                        @if (count($spinaches) > 0)
                            @foreach ($spinaches as $item)
                                <tr>
                                    <td class="text-center align-content-center">{{ $loop->index + 1 }}</td>
                                    <td>
                                        <div class="d-flex flex-column">
                                            <div class="align-items-center d-grip gap-4 mx-auto">
                                                <img src="{{ url('storage/spinach/' . $item->filename) }}" height="100px">
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-center align-content-center">{{ $item->temperature }}°C</td>
                                    <td class="text-center align-content-center">{{ $item->ph }}</td>
                                    ...
                                    <td class="text-center align-content-center">
                                        <div class="d-flex flex-column">
                                            <div class="align-items-center d-grip gap-4 mx-auto">
                                                <a href="{{ route('plant.spinach.edit', $item->uuid) }}"><button
                                                ...
                                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                    data-target="#deleteSpinachModal"
                                                    onclick="hapusDataBayam('{{ $item->uuid }}')">
                                                    <svg xmlns="http://www.w3.org/2000/svg" height="1.2em"
                                                        viewBox="0 0 448 512">
                                                        <style>
                                                            svg {
    ...
    <div class="modal fade" id="deleteSpinachModal" tabindex="-1" role="dialog" aria-labelledby="user-data-modal-label"
        aria-hidden="true">
